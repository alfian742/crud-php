...
<div class="card">
    ...
    <div class="card-body">
        <h5 class="card-title mb-4">Ubah Data Dosen</h5>
        ...
        if (isset($_GET['nidn'])) {
            ...
            header('Location: ?page=dsndata'); // Jika tidak sesuai dengan parameter kembali ke halaman tampil data
        }
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="?page=dsndata" class="btn btn-warning">BATAL</a>
        </form>
    </div>
</div>
<!-- End of content -->